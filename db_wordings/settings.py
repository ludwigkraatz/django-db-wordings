...
USER_SETTINGS = getattr(settings, 'DB_WORDINGS', None)

DEFAULTS = {
    "API_ROOT": None,
#    "WORDING_LANGUAGE_MODEL":
#        "db_wordings.models.WordingLanguage",
#    "SITE_WORDING_MODEL":
#        "db_wordings.models.SiteWording"
}
...
dbwording_settings = LazySettings()
